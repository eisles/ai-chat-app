...
│  /checkpointing --full                                      │
│                      ↓                                      │
│  .Codex/checkpoints/2026-01-28-153000.md                   │
...
│  2. 分析用プロンプトを生成                                    │
│     → .Codex/checkpoints/YYYY-MM-DD-HHMMSS.analyze-prompt.md│
│                      ↓                                      │
│  3. サブエージェントでAI分析を実行                            │
│     → 作業パターンを発見                                      │
│     → スキル候補を提案                                        │
│                      ↓                                      │
│  4. 新スキルを .Codex/skills/ に追加                         │
└─────────────────────────────────────────────────────────────┘
```
...
1. `.Codex/logs/cli-tools.jsonl` を解析
...
3. **チェックポイントファイルを生成**
   - `.Codex/checkpoints/YYYY-MM-DD-HHMMSS.md`
...
- Full Checkpoint は `.Codex/checkpoints/` に蓄積されます
