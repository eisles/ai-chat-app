...
metadata:
  short-description: Codex ↔ Gemini CLI collaboration (research & multimodal)
---
...
> **詳細ルール**: `.Codex/rules/gemini-delegation.md`
...
- prompt: |
    ...
    Save full output to: .Codex/docs/research/{topic}.md
...
4. **Full output saved** → `.Codex/docs/research/{topic}.md`
...
```
.Codex/docs/research/{topic}.md
```

This allows Codex and Codex to reference the research later.
...
- **Shared context**: Results saved for Codex/Codex
