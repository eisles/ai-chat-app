...
metadata:
  short-description: Codex ↔ Codex CLI collaboration
---

# Codex System — Deep Reasoning Partner

**Codex CLI (gpt-5.4) is your highly capable supporter for deep reasoning tasks.**

> **詳細ルール**: `.Codex/rules/codex-delegation.md`
