...
このスキルは3つのエージェント（Codex, Codex, Gemini）を協調させ、プロジェクト開始から実装後レビューまでをカバーする。
...
Phase 1: Research (Gemini via Subagent)
    ↓
Phase 2: Requirements & Planning (Codex)
    ↓
Phase 3: Design Review (Codex via Subagent)
    ↓
Phase 4: Task Creation (Codex)
    ↓
Phase 5: AGENTS.md Update (Codex)
    ↓
[Implementation...]
    ↓
...
- prompt: |
    ...
    2. Save full output to: .Codex/docs/research/{feature}.md
...
## Phase 2: Requirements Gathering (Codex)
...
## Phase 5: AGENTS.md Update (IMPORTANT)

**プロジェクト固有の情報を AGENTS.md に追記する。**
...
### Option A: New Codex Session

1. Start new Codex session
2. Run: `git diff main...HEAD` to see all changes
3. Ask Codex to review the implementation
...
| File | Purpose |
|------|---------|
| `.Codex/docs/research/{feature}.md` | Gemini research output |
...
- **Update AGENTS.md** to persist context across sessions
